...
const App = {
  ...
  start: async function() {
    const { web3 } = this;
    try {
      const idNet = await web3.eth.net.getId();
      const deployNet = supplyChainArtifact.networks[idNet];
      ...
      this.showToastError("Error to connect to chain",error);
      console.error("Error to connect to chain.",error);
    }
  },
  ...
  harvestItem: async function(event) {  
    ...
    this.setStatus("Initiating harvestItem ... wait please...");
    this.readForm();
    let result;
    console.log(App)
    try {
      ...
      this.showToastInfo("harvestItem complete!");
      this.setStatus("harvestItem complete!");
    } catch (error) {
      this.showToastError(error);
      console.log(error);
      this.setStatus("harvestItem failed!");
    }
  ...
  processItem: async function(event) {
    ...
    this.readForm();
    let result;
    this.setStatus("Initiating processItem... wait please...");
    try {
      result = await processItem(
        App.upc,
      ).send({from: App.originFarmerID, gas: 300000});
      console.log('processItem',result);
      this.showToastInfo("processItem complete!");
      this.setStatus("processItem complete!");
    } catch(error) {
      this.showToastError(error);
      console.log(error);
      this.setStatus("processItem failed!");
    }
  },
  ...
  packItem: async function(event) {
    ...
    this.readForm();
    let result;
    this.setStatus("Initiating packItem... wait please...");
    try {
      result = await packItem(
        App.upc,
      ).send({from: App.originFarmerID, gas: 300000});
      console.log('packItem',result);
      this.showToastInfo("packItem complete!");
      this.setStatus("packItem complete!");
    } catch(error) {
      this.showToastError(error);
      console.log(error);
      this.setStatus("packItem failed!");
    }
  },
  ...
  sellItem: async function(event) {
    ...
    this.readForm();
    this.setStatus("Initiating sellItem ... wait please...");
    let result;
    try {
      result = await sellItem(App.upc,price).send({from: App.originFarmerID, gas: 300000});
      console.log('sellItem',result);
      this.showToastInfo("sellItem complete!");
      this.setStatus("sellItem complete!");
    }catch (error) {
      this.showToastError(error);
      console.log(error);
      this.setStatus("sellItem failed!");
    }
  },
  ...
  buyItem: async function(event) {
    ...
    this.setStatus("Initiating buyItem ... wait please...");
    try {
      result = await buyItem(
        App.upc,
      ).send({from: App.distributorID,value: price, gas: 300000});
      console.log('buyItem',result);
      this.showToastInfo("buyItem complete!");
      this.setStatus("buyItem complete!");
    } catch(error) {
      this.showToastError(error);
      console.log(error);
      this.setStatus("buyItem failed!");
    }
  },
  ...
  shipItem: async function(event) {
    ...
    this.readForm();
    this.setStatus("Initiating shipItem ... wait please...");
    let result;
    try {
      result = await shipItem(App.upc).send({from: App.distributorID, gas: 300000});
      console.log('shipItem',result);
      this.setStatus("shipItem complete!");
      this.showToastInfo("shipItem complete!");
    }catch (error) {
      this.showToastError(error);
      console.log(error);
      this.setStatus("shipItem failed!");
    }
  },
  ...
  receiveItem: async function(event) {
    ...
    this.readForm();
    this.setStatus("Initiating receiveItem ... wait please...");
    let result;
    try {
      result = await receiveItem(App.upc).send({from: App.retailerID, gas: 300000});
      console.log('receiveItem',result);
      this.setStatus("receiveItem complete!");
      this.showToastInfo("receiveItem complete!");
    }catch (error) {
      this.showToastError(error);
      console.log(error);
      this.setStatus("receiveItem failed!");
    }
  },
  ...
  purchaseItem: async function(event) {
    ...
    this.readForm();
    this.setStatus("Initiating purchaseItem ... wait please...");
    let result;
    try {
      result = await purchaseItem(App.upc).send({from: App.consumerID, gas: 300000});
      console.log('purchaseItem',result);
      this.showToastInfo("purchadeItem complete!");
      this.setStatus("purchaseItem complete!");
    }catch (error) {
      this.showToastError(error);
      console.log(error);
      this.setStatus("purchaseItem failed!");
    }
  },
  ...
  fetchItemBufferOne: async function () {
    ...
    this.showToastInfo("fetchData1 complete!");
    $("#sku").val(result[0]);
  ...
  fetchItemBufferTwo: async function() {
    ...
    this.showToastInfo("fetchData2 complete!");
